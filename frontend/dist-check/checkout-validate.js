...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  var createLucideIcon = (iconName, iconNode) => {
    const Component5 = (0, import_react21.forwardRef)(
  ...
  var CreditCard = createLucideIcon("credit-card", __iconNode2);
  ...
  var MapPin = createLucideIcon("map-pin", __iconNode3);
  ...
  function useStore(api, selector = identity) {
    const slice = import_react22.default.useSyncExternalStore(
      api.subscribe,
      import_react22.default.useCallback(() => selector(api.getState()), [api, selector]),
      import_react22.default.useCallback(() => selector(api.getInitialState()), [api, selector])
    );
    import_react22.default.useDebugValue(slice);
    return slice;
  }
  ...
  var getAccessToken = () => isBrowser3() ? localStorage.getItem(ACCESS_TOKEN_KEY) : null;
  ...
  var import_meta2 = {};
  var API_BASE_URL = import_meta2.env.VITE_API_BASE_URL || "http://localhost:3000/api/v1";
  ...
  var import_meta3 = {};
  var API_BASE_URL2 = import_meta3.env.VITE_API_BASE_URL || "http://localhost:3000/api/v1";
  var redirectToLogin = () => {
    clearSession();
    setTimeout(() => {
  ...
  axiosInstance.interceptors.response.use(
    ...
    async (error) => {
      ...
      if (error.response) {
        ...
        return Promise.reject(data2 || error.message);
      }
      if (error.request) {
  ...
  var normalizePayload2 = (response) => response?.data || response || {};
  var normalizeUserPayload = (response) => {
    const payload = normalizePayload2(response);
    return payload?.data || payload?.user || payload || null;
  };
  var authAPI = {
    register: async (userData) => {
      return await axiosConfig_default.post("/auth/register", userData, {
        headers: { "Content-Type": "application/x-www-form-urlencoded" }
      });
    },
    login: async (credentials) => {
      const response = await axiosConfig_default.post("/auth/login", credentials, {
        headers: { "Content-Type": "application/x-www-form-urlencoded" }
      });
      applySessionPayload(normalizePayload2(response));
      return response;
    },
    refresh: async () => {
    ...
    logout: async () => {
      ...
      if (token) {
        try {
          await axiosConfig_default.post(
            "/auth/logout",
            {},
            {
    ...
    getProfile: async () => {
      return await axiosConfig_default.get("/auth/me");
    },
    updateProfile: async (userData) => {
      const response = await axiosConfig_default.patch("/auth/me/profile", userData, {
        headers: { "Content-Type": "application/x-www-form-urlencoded" }
      });
    ...
    changePassword: async (passwordData) => {
      return await axiosConfig_default.patch("/auth/me/password", passwordData, {
        headers: { "Content-Type": "application/x-www-form-urlencoded" }
      });
    },
    getAllUsers: async (page = 1, limit = 10) => {
      return await axiosConfig_default.get("/admin/users", {
        params: { page, limit }
      });
    },
    updateUserStatus: async (userId, isActive) => {
      return await axiosConfig_default.patch(`/admin/users/${userId}/active`, {
        isActive
      });
    },
  ...
  var cartAPI = {
    // Lấy giỏ hàng
    getCart: async () => {
      return await axiosConfig_default.get("/cart/", {
        skipAuthRedirect: true
      });
    },
    // Thêm sản phẩm vào giỏ hàng
    addToCart: async (productId, quantity = 1) => {
      return await axiosConfig_default.post(
        "/cart/add",
        { productId, quantity },
        { headers: { "Content-Type": "application/x-www-form-urlencoded" } }
      );
    ...
    removeFromCart: async (cartItemId) => {
      return await axiosConfig_default.delete(`/cart/remove/${cartItemId}`);
    }
  };
  var cartAPI_default = cartAPI;

  // src/services/orderAPI.js
  var normalizeOrderListResponse = (response) => {
    const data2 = response?.data ?? response;
    const orders = Array.isArray(data2) ? data2 : data2?.orders || data2?.data || response?.orders || [];
    return {
      ...response,
      data: orders
    };
  };
  var normalizeOrderDetailResponse = (response) => {
    const data2 = response?.data ?? response;
    const order = data2 && !Array.isArray(data2) ? data2?.order || data2?.data || data2 : null;
    return {
      ...response,
      data: order
    };
  ...
  var orderAPI = {
    ...
    createOrder: async (orderData) => {
      return await axiosConfig_default.post("/orders/add", orderData);
    },
    // Lấy danh sách đơn hàng của user
    getUserOrders: async (page = 1, limit = 10) => {
      const response = await axiosConfig_default.get("/orders/", {
        params: { page, limit }
      });
    ...
    getOrderById: async (orderId) => {
      const response = await axiosConfig_default.get(`/orders/${orderId}`);
      return normalizeOrderDetailResponse(response);
    },
    // Hủy đơn hàng
    cancelOrder: async (orderId) => {
      return await axiosConfig_default.put(`/orders/${orderId}/cancel`);
    },
    // Admin: Lấy tất cả đơn hàng
    getAllOrders: async (page = 1, limit = 10, status = null) => {
      const params = { page, limit };
      if (status) params.status = status;
      const response = await axiosConfig_default.get("/orders/admin/all", { params });
      return normalizeOrderListResponse(response);
    },
  ...
  var orderAPI_default = orderAPI;

  // src/services/couponAPI.js
  var couponAPI = {
    // Lấy tất cả mã giảm giá
    getAllCoupons: async () => {
      return await axiosConfig_default.get("/coupons/");
    },
    // Lấy mã giảm giá theo code
    getCouponByCode: async (code) => {
      return await axiosConfig_default.get(`/coupons/code/${code}`);
    },
    // Kiểm tra mã giảm giá có hợp lệ không
    validateCoupon: async (code) => {
      return await axiosConfig_default.get(`/coupons/validate/${code}`);
    },
    // Admin: Thêm mã giảm giá mới
    createCoupon: async (couponData) => {
      return await axiosConfig_default.post("/coupons/add", couponData);
    },
    // Admin: Cập nhật mã giảm giá
    updateCoupon: async (couponId, couponData) => {
      return await axiosConfig_default.put(`/coupons/update/${couponId}`, couponData);
    },
    // Admin: Xóa mã giảm giá
    deleteCoupon: async (couponId) => {
      return await axiosConfig_default.delete(`/coupons/delete/${couponId}`);
    }
  };
  var couponAPI_default = couponAPI;

  // src/services/paymentAPI.js
  var paymentAPI = {
    getPaymentMethods: async () => {
      return await axiosConfig_default.get("/payments/methods");
    },
    createPayment: async (paymentData) => {
      return await axiosConfig_default.post("/payments", paymentData);
    },
    getOrderPayment: async (orderId) => {
      return await axiosConfig_default.get(`/payments/order/${orderId}`);
    },
    verifyVnpayReturn: async (params) => {
      return await axiosConfig_default.get("/payments/vnpay/return", { params });
    }
  };
  var paymentAPI_default = paymentAPI;

  // src/services/addressAPI.js
  var addressAPI = {
    // Lấy danh sách địa chỉ của user hiện tại
    getMyAddresses: async () => {
      return await axiosConfig_default.get("/addresses/");
    },
    // Lấy địa chỉ mặc định
    getDefaultAddress: async () => {
      return await axiosConfig_default.get("/addresses/default");
    },
    // Tạo địa chỉ mới
    createAddress: async (data2) => {
      return await axiosConfig_default.post("/addresses/", data2);
    },
    // Cập nhật địa chỉ
    updateAddress: async (id3, data2) => {
      return await axiosConfig_default.put(`/addresses/${id3}`, data2);
    },
    // Xóa địa chỉ
    deleteAddress: async (id3) => {
      return await axiosConfig_default.delete(`/addresses/${id3}`);
    }
  };
  var addressAPI_default = addressAPI;
  ...
  var useCartStore = create((set, get) => ({
    ...
    fetchCart: async () => {
      ...
      try {
        const response = await cartAPI_default.getCart();
        ...
        set({
          ...
          totalPrice: 0,
          error: null,
          // Don't show error to user if cart is just empty
          isLoading: false
        });
      }
    },
    ...
    addToCart: async (productId, quantity = 1) => {
      set({ isLoading: true, error: null });
      try {
        const response = await cartAPI_default.addToCart(productId, quantity);
        await get().fetchCart();
        return true;
      } catch (error) {
        console.error("Add to cart error:", error);
        set({
          error: error.message || "Kh\xF4ng th\u1EC3 th\xEAm v\xE0o gi\u1ECF h\xE0ng",
          isLoading: false
        });
        throw error;
      }
    ...
    updateQuantity: async (cartItemId, quantity) => {
      set({ isLoading: true, error: null });
      try {
        await cartAPI_default.updateCartItem(cartItemId, quantity);
        await get().fetchCart();
        return true;
      } catch (error) {
        set({
          error: error.message || "Kh\xF4ng th\u1EC3 c\u1EADp nh\u1EADt",
          isLoading: false
        });
        throw error;
      }
    ...
    removeFromCart: async (cartItemId) => {
      set({ isLoading: true, error: null });
      try {
        await cartAPI_default.removeFromCart(cartItemId);
        await get().fetchCart();
        return true;
      } catch (error) {
        set({
          error: error.message || "Kh\xF4ng th\u1EC3 x\xF3a s\u1EA3n ph\u1EA9m",
          isLoading: false
        });
        throw error;
      }
  ...
  var useCartStore_default = useCartStore;

  // src/stores/useAuthStore.js
  var extractUserPayload = (payload) => payload?.data?.user || payload?.data?.data || payload?.user || payload?.data || payload || null;
  var useAuthStore = create((set) => ({
    ...
    initialize: async () => {
      ...
      try {
        const restoredSession = await authAPI_default.restoreSession();
        if (!restoredSession) {
          set({
            user: null,
            token: null,
    ...
    login: async (credentials) => {
      set({ isLoading: true, error: null });
      try {
        const response = await authAPI_default.login(credentials);
    ...
    register: async (userData) => {
      set({ isLoading: true, error: null });
      try {
        const response = await authAPI_default.register(userData);
        set({ isLoading: false });
        return response;
      } catch (error) {
        set({
    ...
    updateProfile: async (userData) => {
      set({ isLoading: true, error: null });
      try {
        const response = await authAPI_default.updateProfile(userData);
  ...
  var PROVINCE_API_BASE_URL = "https://provinces.open-api.vn/api/v1";
  var getAllProvinces = async () => {
    try {
      const response = await axios_default.get(`${PROVINCE_API_BASE_URL}/p/`);
  ...
  var getDistrictsByProvince = async (provinceCode) => {
    try {
  ...
  var getWardsByDistrict = async (districtCode) => {
    try {
      const response = await axios_default.get(
  ...
  var provinceAPI_default = provinceAPI;
  ...
  var isVietnamesePhone = (value) => /^(0|\+84)(3|5|7|8|9)\d{8}$/.test(String(value || "").trim());
  var isPositiveInteger = (value) => {
    const number2 = Number(value);
    return Number.isInteger(number2) && number2 > 0;
  };
  ...
  var validateCheckoutForm = ({
    ...
    if (!Array.isArray(items) || items.length === 0) {
      ...
      const invalidItem = items.find(
        (item) => !isPositiveInteger(item.id || item.cartItemId) || !isPositiveInteger(item.productId || item.product_id) || !isPositiveInteger(item.quantity)
      );
      if (invalidItem) {
  ...
  var PAYMENT_METHOD_CONFIG = {
    COD: {
      title: "Thanh to\xE1n khi nh\u1EADn h\xE0ng (COD)",
      description: "T\u1EA1o \u0111\u01A1n h\xE0ng v\xE0 x\u1EED l\xFD giao h\xE0ng theo h\xECnh th\u1EE9c thanh to\xE1n khi nh\u1EADn."
    },
    VNPAY: {
      title: "Thanh to\xE1n qua VNPay",
      description: "T\u1EA1o \u0111\u01A1n ch\u1EDD thanh to\xE1n v\xE0 chuy\u1EC3n b\u1EA1n sang c\u1ED5ng VNPay \u0111\u1EC3 ho\xE0n t\u1EA5t giao d\u1ECBch."
    }
  };
  ...
  var unwrapResponseData = (response) => response?.data?.data || response?.data || response;
  var unwrapListData = (response) => {
    const data2 = unwrapResponseData(response);
    return Array.isArray(data2) ? data2 : [];
  };
  var getImageSrc = (imageUrl) => {
    if (!imageUrl) {
  ...
  var CheckoutPage = () => {
    ...
    const { items, totalPrice, fetchCart } = useCartStore_default();
    const { user } = useAuthStore_default();
    const [isSubmitting, setIsSubmitting] = (0, import_react23.useState)(false);
    const [orderSuccess, setOrderSuccess] = (0, import_react23.useState)(false);
    const [orderId, setOrderId] = (0, import_react23.useState)(null);
    const [paymentMethods, setPaymentMethods] = (0, import_react23.useState)(DEFAULT_PAYMENT_METHODS);
    const [couponCode, setCouponCode] = (0, import_react23.useState)("");
    const [appliedCoupon, setAppliedCoupon] = (0, import_react23.useState)(null);
    const [isValidatingCoupon, setIsValidatingCoupon] = (0, import_react23.useState)(false);
    const [discountAmount, setDiscountAmount] = (0, import_react23.useState)(0);
    const [availableCoupons, setAvailableCoupons] = (0, import_react23.useState)([]);
    const [provinces, setProvinces] = (0, import_react23.useState)([]);
    const [districts, setDistricts] = (0, import_react23.useState)([]);
    const [wards, setWards] = (0, import_react23.useState)([]);
    const [selectedProvince, setSelectedProvince] = (0, import_react23.useState)(null);
    const [selectedDistrict, setSelectedDistrict] = (0, import_react23.useState)(null);
    const [selectedWard, setSelectedWard] = (0, import_react23.useState)(null);
    const [addressMode, setAddressMode] = (0, import_react23.useState)("new");
    const [savedAddresses, setSavedAddresses] = (0, import_react23.useState)([]);
    const [selectedAddressId, setSelectedAddressId] = (0, import_react23.useState)(null);
    const [isLoadingAddresses, setIsLoadingAddresses] = (0, import_react23.useState)(false);
    const [newAddressType, setNewAddressType] = (0, import_react23.useState)("home");
    ...
    const [formErrors, setFormErrors] = (0, import_react23.useState)({});
    (0, import_react23.useEffect)(() => {
      const fetchProvinces = async () => {
        try {
          const data2 = await provinceAPI_default.getAllProvinces();
          setProvinces(data2);
        } catch (error) {
          console.error("Error fetching provinces:", error);
          toast.error("Kh\xF4ng th\u1EC3 t\u1EA3i danh s\xE1ch t\u1EC9nh th\xE0nh");
        }
      };
      const fetchSavedAddresses = async () => {
        setIsLoadingAddresses(true);
        try {
          const response = await addressAPI_default.getMyAddresses();
    ...
    (0, import_react23.useEffect)(() => {
      const fetchCoupons = async () => {
        try {
          const response = await couponAPI_default.getAllCoupons();
    ...
    (0, import_react23.useEffect)(() => {
      const fetchPaymentMethods = async () => {
        try {
          const response = await paymentAPI_default.getPaymentMethods();
    ...
    const handleProvinceChange = async (e) => {
      ...
      try {
        const data2 = await provinceAPI_default.getDistrictsByProvince(provinceCode);
        setDistricts(data2.districts || []);
      } catch (error) {
        console.error("Error fetching districts:", error);
        toast.error("Kh\xF4ng th\u1EC3 t\u1EA3i danh s\xE1ch qu\u1EADn/huy\u1EC7n");
      }
    };
    const handleDistrictChange = async (e) => {
      ...
      try {
        const data2 = await provinceAPI_default.getWardsByDistrict(districtCode);
        setWards(data2.wards || []);
      } catch (error) {
        console.error("Error fetching wards:", error);
        toast.error("Kh\xF4ng th\u1EC3 t\u1EA3i danh s\xE1ch ph\u01B0\u1EDDng/x\xE3");
      }
    };
    ...
    const handleApplyCoupon = () => {
      if (!couponCode.trim()) {
        toast.error("Vui l\xF2ng nh\u1EADp m\xE3 gi\u1EA3m gi\xE1");
        return;
      }
      ...
      if (!foundCoupon) {
        toast.error("M\xE3 gi\u1EA3m gi\xE1 kh\xF4ng t\u1ED3n t\u1EA1i");
      ...
      if (currentDate < startDate) {
        toast.error("M\xE3 gi\u1EA3m gi\xE1 ch\u01B0a b\u1EAFt \u0111\u1EA7u hi\u1EC7u l\u1EF1c");
        setIsValidatingCoupon(false);
        return;
      }
      if (currentDate > endDate) {
        toast.error("M\xE3 gi\u1EA3m gi\xE1 \u0111\xE3 h\u1EBFt h\u1EA1n");
        setIsValidatingCoupon(false);
        return;
      }
      if (foundCoupon.currentUsage >= foundCoupon.usageLimit) {
        toast.error("M\xE3 gi\u1EA3m gi\xE1 \u0111\xE3 h\u1EBFt l\u01B0\u1EE3t s\u1EED d\u1EE5ng");
        setIsValidatingCoupon(false);
        return;
      }
      ...
      toast.success(`\xC1p d\u1EE5ng m\xE3 gi\u1EA3m gi\xE1 ${foundCoupon.discountPercent}% th\xE0nh c\xF4ng!`);
      setIsValidatingCoupon(false);
    };
    const handleRemoveCoupon = () => {
      ...
      setDiscountAmount(0);
      toast.success("\u0110\xE3 x\xF3a m\xE3 gi\u1EA3m gi\xE1");
    };
    const finalPrice = totalPrice - discountAmount;
    const selectedPaymentConfig = PAYMENT_METHOD_CONFIG[formData.paymentMethod] || PAYMENT_METHOD_CONFIG.COD;
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await orderAPI_default.createOrder(orderData);
        const createdOrder = unwrapResponseData(response);
        createdOrderId = createdOrder?.id || createdOrder?.orderId || null;
        if (!createdOrderId) {
          throw new Error("Kh\xF4ng th\u1EC3 l\u1EA5y m\xE3 \u0111\u01A1n h\xE0ng sau khi t\u1EA1o \u0111\u01A1n");
        }
        if (formData.paymentMethod === "VNPAY") {
          const paymentData = createdOrder?.payment || null;
          if (!paymentData?.paymentUrl) {
            throw new Error("Kh\xF4ng nh\u1EADn \u0111\u01B0\u1EE3c \u0111\u01B0\u1EDDng d\u1EABn thanh to\xE1n VNPay");
          }
          toast.success("\u0110\u01A1n h\xE0ng \u0111\xE3 \u0111\u01B0\u1EE3c t\u1EA1o. \u0110ang chuy\u1EC3n sang VNPay...");
        ...
        await fetchCart();
        toast.success("\u0110\u1EB7t h\xE0ng th\xE0nh c\xF4ng!");
        setTimeout(() => {
          navigate("/profile/orders");
        }, 3e3);
      } catch (error) {
        console.error("L\u1ED7i khi \u0111\u1EB7t h\xE0ng:", error);
        ...
        toast.error(
          getApiErrorMessage(
            error,
            createdOrderId ? `Don hang #${createdOrderId} da tao nhung chua hoan tat xu ly.` : "Khong the dat hang. Vui long thu lai"
          )
        );
      } finally {
    ...
    if (orderSuccess) {
      return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen px-3 py-10 md:px-6" }, /* @__PURE__ */ React.createElement("div", { className: "container mx-auto px-4" }, /* @__PURE__ */ React.createElement(
        motion.div,
        {
        ...
        /* @__PURE__ */ React.createElement("div", { className: "mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-emerald-100/80" }, /* @__PURE__ */ React.createElement(CircleCheckBig, { className: "h-12 w-12 text-green-600" })),
        /* @__PURE__ */ React.createElement("h2", { className: "mb-3 text-2xl font-bold text-gray-900" }, "\u0110\u1EB7t h\xE0ng th\xE0nh c\xF4ng!"),
        /* @__PURE__ */ React.createElement("p", { className: "mb-2 text-gray-600" }, "C\u1EA3m \u01A1n b\u1EA1n \u0111\xE3 \u0111\u1EB7t h\xE0ng t\u1EA1i CoffeeBot"),
        orderId && /* @__PURE__ */ React.createElement("p", { className: "mb-6 text-sm text-gray-500" }, "M\xE3 \u0111\u01A1n h\xE0ng: ", /* @__PURE__ */ React.createElement("span", { className: "font-mono font-bold" }, "#", orderId)),
        /* @__PURE__ */ React.createElement("p", { className: "mb-6 text-sm text-gray-600" }, "Ch\xFAng t\xF4i s\u1EBD li\xEAn h\u1EC7 v\u1EDBi b\u1EA1n s\u1EDBm nh\u1EA5t \u0111\u1EC3 x\xE1c nh\u1EADn \u0111\u01A1n h\xE0ng"),
        /* @__PURE__ */ React.createElement(Button_default, { onClick: () => navigate("/profile/orders"), variant: "primary" }, "Xem \u0111\u01A1n h\xE0ng")
      )));
    }
    return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen px-3 py-6 md:px-6 md:py-8" }, /* @__PURE__ */ React.createElement("div", { className: "container mx-auto px-4" }, /* @__PURE__ */ React.createElement("h1", { className: "mb-8 text-3xl font-bold text-gray-900" }, "Thanh to\xE1n"), /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-3" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-6 lg:col-span-2" }, /* @__PURE__ */ React.createElement("div", { className: "glass-card rounded-[28px] p-6" }, /* @__PURE__ */ React.createElement("div", { className: "mb-6 flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "glass-card rounded-2xl p-2" }, /* @__PURE__ */ React.createElement(MapPin, { className: "h-6 w-6 text-coffee-600" })), /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-bold text-gray-900" }, "\u0110\u1ECBa ch\u1EC9 giao h\xE0ng")), /* @__PURE__ */ React.createElement("div", { className: "mb-6 grid grid-cols-1 gap-4 md:grid-cols-2" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
        ...
        required: true,
        icon: /* @__PURE__ */ React.createElement(User, { className: "h-5 w-5" })
      }
    ), /* @__PURE__ */ React.createElement(
      Input_default,
      {
    ...
    ))), /* @__PURE__ */ React.createElement("div", { className: "mb-6 border-t border-white/25 pt-6" }, /* @__PURE__ */ React.createElement("p", { className: "mb-4 text-sm font-semibold text-gray-700" }, "Ch\u1ECDn \u0111\u1ECBa ch\u1EC9 giao h\xE0ng"), /* @__PURE__ */ React.createElement("div", { className: "mb-5 flex gap-3" }, savedAddresses.length > 0 && /* @__PURE__ */ React.createElement("label", { className: "glass-card flex flex-1 cursor-pointer items-center gap-3 rounded-[20px] border border-transparent p-3 transition-all hover:border-coffee-300" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "radio",
        value: "existing",
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-gray-700" }, "S\u1EED d\u1EE5ng \u0111\u1ECBa ch\u1EC9 c\xF3 s\u1EB5n (", savedAddresses.length, ")")), /* @__PURE__ */ React.createElement("label", { className: "glass-card flex flex-1 cursor-pointer items-center gap-3 rounded-[20px] border border-transparent p-3 transition-all hover:border-coffee-300" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "radio",
        value: "new",
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-gray-700" }, "Th\xEAm \u0111\u1ECBa ch\u1EC9 m\u1EDBi"))), addressMode === "existing" && savedAddresses.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "mb-6 space-y-3" }, savedAddresses.map((addr) => /* @__PURE__ */ React.createElement(
      "label",
      {
        key: addr.id,
        className: `glass-card flex cursor-pointer gap-4 rounded-[20px] border p-3 transition-all ${selectedAddressId === addr.id ? "border-coffee-400 bg-coffee-50/50" : "border-white/25 hover:border-coffee-200"}`
      },
      /* @__PURE__ */ React.createElement(
        "input",
        {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("p", { className: "font-semibold text-gray-900" }, addr.receiverName), /* @__PURE__ */ React.createElement("span", { className: `rounded-full px-2 py-0.5 text-xs font-medium ${addr.addressType === "home" ? "bg-blue-100 text-blue-700" : "bg-orange-100 text-orange-700"}` }, addr.addressType === "home" ? "Nh\xE0" : "V\u0103n ph\xF2ng"), addr.isDefault && /* @__PURE__ */ React.createElement("span", { className: "rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-700" }, "M\u1EB7c \u0111\u1ECBnh")), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, addr.phoneNumber), /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-gray-600" }, addr.fullAddress))
    ))), formErrors.selectedAddressId && /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-sm text-red-600" }, formErrors.selectedAddressId), addressMode === "new" && /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
      Input_default,
      {
        label: "\u0110\u1ECBa ch\u1EC9 chi ti\u1EBFt (S\u1ED1 nh\xE0, t\xEAn \u0111\u01B0\u1EDDng)",
        name: "shipAddress",
    ...
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-gray-700" }, "T\u1EC9nh / Th\xE0nh ph\u1ED1 ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "Ch\u1ECDn t\u1EC9nh/th\xE0nh ph\u1ED1"),
      provinces.map((province) => /* @__PURE__ */ React.createElement("option", { key: province.code, value: province.code }, province.name))
    ), formErrors.selectedProvince && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.selectedProvince)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-gray-700" }, "Qu\u1EADn / Huy\u1EC7n ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "Ch\u1ECDn qu\u1EADn/huy\u1EC7n"),
      districts.map((district) => /* @__PURE__ */ React.createElement("option", { key: district.code, value: district.code }, district.name))
    ), formErrors.selectedDistrict && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.selectedDistrict)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-gray-700" }, "Ph\u01B0\u1EDDng / X\xE3 ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "Ch\u1ECDn ph\u01B0\u1EDDng/x\xE3"),
      wards.map((ward) => /* @__PURE__ */ React.createElement("option", { key: ward.code, value: ward.code }, ward.name))
    ), formErrors.selectedWard && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.selectedWard)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-gray-700" }, "Lo\u1EA1i \u0111\u1ECBa ch\u1EC9 ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3" }, /* @__PURE__ */ React.createElement("label", { className: "glass-card flex flex-1 cursor-pointer items-center gap-2 rounded-[16px] border border-white/25 p-3 transition-all hover:border-coffee-300" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "radio",
        value: "home",
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-gray-700" }, "Nh\xE0 ri\xEAng")), /* @__PURE__ */ React.createElement("label", { className: "glass-card flex flex-1 cursor-pointer items-center gap-2 rounded-[16px] border border-white/25 p-3 transition-all hover:border-coffee-300" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "radio",
        value: "office",
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium text-gray-700" }, "V\u0103n ph\xF2ng"))), formErrors.addressType && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.addressType)))), /* @__PURE__ */ React.createElement("div", { className: "md:col-span-2" }, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-gray-700" }, "Ghi ch\xFA (t\xF9y ch\u1ECDn)"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        name: "note",
        value: formData.note,
        ...
        rows: "3",
        className: "glass-textarea w-full",
        placeholder: "Ghi ch\xFA v\u1EC1 \u0111\u01A1n h\xE0ng (th\u1EDDi gian giao, y\xEAu c\u1EA7u \u0111\u1EB7c bi\u1EC7t...)"
      }
    )), formErrors.paymentMethod && /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm text-red-600" }, formErrors.paymentMethod)), /* @__PURE__ */ React.createElement("div", { className: "glass-card rounded-[28px] p-6" }, /* @__PURE__ */ React.createElement("div", { className: "mb-6 flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "glass-card rounded-2xl p-2" }, /* @__PURE__ */ React.createElement(CreditCard, { className: "h-6 w-6 text-coffee-600" })), /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-bold text-gray-900" }, "Ph\u01B0\u01A1ng th\u1EE9c thanh to\xE1n")), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, paymentMethods.map((method) => {
      const config = PAYMENT_METHOD_CONFIG[method.code] || PAYMENT_METHOD_CONFIG.COD;
      return /* @__PURE__ */ React.createElement(
        "label",
        {
          key: method.code,
          className: `glass-card flex items-center gap-3 rounded-[24px] p-4 transition-all ${method.enabled ? "cursor-pointer hover:-translate-y-0.5" : "cursor-not-allowed opacity-60"}`
        },
        /* @__PURE__ */ React.createElement(
          "input",
          {
        ...
        /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "font-semibold text-gray-900" }, config.title), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, config.description), !method.enabled && method.code === "VNPAY" && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-xs text-amber-700" }, "VNPay ch\u01B0a s\u1EB5n s\xE0ng v\xEC server ch\u01B0a c\u1EA5u h\xECnh `VNPAY_*`."))
      );
    })), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-sm text-slate-500" }, selectedPaymentConfig.description))), /* @__PURE__ */ React.createElement("div", { className: "lg:col-span-1" }, /* @__PURE__ */ React.createElement("div", { className: "glass-panel sticky top-28 rounded-[32px] p-6" }, /* @__PURE__ */ React.createElement("h2", { className: "mb-6 text-xl font-bold text-gray-900" }, "\u0110\u01A1n h\xE0ng c\u1EE7a b\u1EA1n"), /* @__PURE__ */ React.createElement("div", { className: "mb-6 max-h-60 space-y-3 overflow-y-auto" }, items?.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, className: "flex gap-3" }, /* @__PURE__ */ React.createElement(
      "img",
      {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "line-clamp-2 text-sm font-medium text-gray-900" }, item.name), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, item.quantity, " x ", formatCurrency(item.unitPrice)))))), /* @__PURE__ */ React.createElement("div", { className: "mb-4 border-t border-white/25 pt-4" }, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-gray-700" }, "M\xE3 gi\u1EA3m gi\xE1"), appliedCoupon ? /* @__PURE__ */ React.createElement("div", { className: "glass-card flex items-center justify-between rounded-[20px] border border-emerald-200/70 p-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "font-semibold text-green-700" }, appliedCoupon.code), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-green-600" }, "Gi\u1EA3m ", appliedCoupon.discountPercent, "%")), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      isValidatingCoupon ? "\u0110ang ki\u1EC3m tra..." : "\xC1p d\u1EE5ng"
    ))), /* @__PURE__ */ React.createElement("div", { className: "mb-6 space-y-2 border-t border-white/25 pt-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-gray-600" }, /* @__PURE__ */ React.createElement("span", null, "T\u1EA1m t\xEDnh"), /* @__PURE__ */ React.createElement("span", null, formatCurrency(totalPrice))), appliedCoupon && /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-green-600" }, /* @__PURE__ */ React.createElement("span", null, "Gi\u1EA3m gi\xE1 (", appliedCoupon.discountPercent, "%)"), /* @__PURE__ */ React.createElement("span", null, "-", formatCurrency(discountAmount))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-gray-600" }, /* @__PURE__ */ React.createElement("span", null, "Ph\xED v\u1EADn chuy\u1EC3n"), /* @__PURE__ */ React.createElement("span", { className: "text-green-600" }, "Mi\u1EC5n ph\xED")), /* @__PURE__ */ React.createElement("div", { className: "border-t border-white/25 pt-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-lg font-bold text-gray-900" }, /* @__PURE__ */ React.createElement("span", null, "T\u1ED5ng c\u1ED9ng"), /* @__PURE__ */ React.createElement("span", { className: "text-coffee-600" }, formatCurrency(finalPrice))))), /* @__PURE__ */ React.createElement(
      Button_default,
      {
        type: "submit",
        variant: "primary",
      ...
      isSubmitting ? "\u0110ang x\u1EED l\xFD..." : formData.paymentMethod === "VNPAY" ? "Ti\u1EBFp t\u1EE5c \u0111\u1EBFn VNPay" : "\u0110\u1EB7t h\xE0ng"
    ), formErrors.cartItems && /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-sm text-red-600" }, formErrors.cartItems), /* @__PURE__ */ React.createElement("p", { className: "mt-4 text-center text-xs text-slate-500" }, "B\u1EB1ng vi\u1EC7c \u0111\u1EB7t h\xE0ng, b\u1EA1n \u0111\u1ED3ng \xFD v\u1EDBi", " ", /* @__PURE__ */ React.createElement("a", { href: "/terms", className: "text-coffee-600 hover:underline" }, "\u0110i\u1EC1u kho\u1EA3n s\u1EED d\u1EE5ng"), " ", "c\u1EE7a ch\xFAng t\xF4i")))))));
  };
