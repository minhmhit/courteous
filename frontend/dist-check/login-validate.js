...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  // src/utils/employeeAccess.js
  var MANAGER_KEYWORDS = [
    "manager",
    "lead",
    "head",
    "supervisor",
  ...
  var normalizeText = (value) => String(value || "").normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase().trim();
  var extractPositionText = (profile) => profile?.currentPosition?.name || profile?.currentPositionName || profile?.positionName || profile?.position?.name || profile?.jobTitle || profile?.title || "";
  var isManagementEmployee = (roleId, employeeProfile) => {
    ...
    return MANAGER_KEYWORDS.some(
      (keyword) => normalizedPosition.includes(keyword)
    );
  };
  var getEnterpriseLandingPath = (roleId, employeeProfile) => {
    ...
    if (normalizedRole === 4) {
      return isManagementEmployee(normalizedRole, employeeProfile) ? "/admin/sales-dashboard" : "/employee/dashboard";
    }
    if (normalizedRole === 5) {
      return isManagementEmployee(normalizedRole, employeeProfile) ? "/admin/hrm-dashboard" : "/employee/dashboard";
    }
    if (normalizedRole === 2) {
  ...
  var validateLoginForm = (formData) => {
    const errors = {};
  ...
  var LoginPage = () => {
    ...
    const { login, isLoading } = useAuthStore_default();
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if ([2, 4, 5].includes(Number(roleId))) {
          try {
            const profileRes = await employeeAPI_default.getMyProfile();
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gradient-to-br from-coffee-50 to-cream-100 flex items-center justify-center p-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-xl p-8 w-full max-w-md" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-8" }, /* @__PURE__ */ React.createElement(Coffee, { className: "w-16 h-16 mx-auto mb-4 text-coffee-600" }), /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-gray-900" }, "Dang Nhap"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mt-2" }, "Chao mung tro lai")), /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit, className: "space-y-4" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
      ...
      "Dang Nhap"
    )), /* @__PURE__ */ React.createElement("p", { className: "text-center mt-6 text-gray-600" }, "Chua co tai khoan?", " ", /* @__PURE__ */ React.createElement(
      Link,
      {
        to: "/register",
