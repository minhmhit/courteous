(() => {
  ...
  var Tag = createLucideIcon("tag", __iconNode6);
  ...
  var getAccessToken = () => isBrowser() ? localStorage.getItem(ACCESS_TOKEN_KEY) : null;
  ...
  var Modal = ({ isOpen, onClose, title, children, size = "md" }) => {
    const sizes = {
      sm: "max-w-md",
      md: "max-w-2xl",
      lg: "max-w-4xl",
    ...
    return /* @__PURE__ */ React.createElement(AnimatePresence, null, isOpen && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-50 overflow-y-auto" }, /* @__PURE__ */ React.createElement("div", { className: "flex min-h-screen items-center justify-center px-4 pb-20 pt-4" }, /* @__PURE__ */ React.createElement(
      motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between border-b border-white/25 px-6 py-4" }, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-semibold text-slate-900" }, title), /* @__PURE__ */ React.createElement(
        "button",
        {
          onClick: onClose,
      ...
      /* @__PURE__ */ React.createElement("div", { className: "max-h-[70vh] overflow-y-auto" }, children)
    ))));
  };
  ...
  function useStore(api, selector = identity) {
    const slice = import_react27.default.useSyncExternalStore(
      api.subscribe,
      import_react27.default.useCallback(() => selector(api.getState()), [api, selector]),
      import_react27.default.useCallback(() => selector(api.getInitialState()), [api, selector])
    );
    import_react27.default.useDebugValue(slice);
    return slice;
  }
  ...
  var formatDate = (dateValue, options = {}) => {
    if (!dateValue) {
      return "N/A";
    }
    try {
  ...
  var validateCouponForm = (formData) => {
    const errors = {};
  ...
  function AdminCouponsPage() {
    ...
    const [form, setForm] = (0, import_react28.useState)(emptyForm);
    const [formErrors, setFormErrors] = (0, import_react28.useState)({});
    ...
    const loadCoupons = async () => {
      setLoading(true);
      try {
        const res = await couponAPI_default.getAllCoupons();
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (editing?.id) {
          await couponAPI_default.updateCoupon(editing.id, payload);
          toast.success("Cap nhat ma giam gia thanh cong");
        } else {
          await couponAPI_default.createCoupon(payload);
    ...
    const handleDelete = async (coupon) => {
      ...
      try {
        await couponAPI_default.deleteCoupon(coupon.id);
    ...
    const filteredCoupons = [...coupons].filter((coupon) => {
      ...
      const isInValidPeriod = (!validFrom || now2 >= validFrom) && (!validUntil || now2 <= validUntil);
      ...
      const fromMatch = !filters.validFrom || validFrom && validFrom >= /* @__PURE__ */ new Date(`${filters.validFrom}T00:00:00`);
      const toMatch = !filters.validUntil || validUntil && validUntil <= /* @__PURE__ */ new Date(`${filters.validUntil}T23:59:59`);
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "glass-card flex flex-col gap-4 lg:flex-row lg:items-center justify-between p-4 rounded-3xl shadow-sm border border-white/20 bg-white/40" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-orange-100 text-orange-600" }, /* @__PURE__ */ React.createElement(Tag, { className: "h-5 w-5" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "text-xl font-bold text-slate-900" }, "Ma giam gia"))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "w-full sm:w-48" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
        placeholder: "Tim ma coupon...",
        value: searchTerm,
        onChange: (e) => setSearchTerm(e.target.value),
        icon: /* @__PURE__ */ React.createElement(Search, { className: "h-4 w-4" })
      }
    )), /* @__PURE__ */ React.createElement("select", { value: filters.status, onChange: (e) => setFilters((prev) => ({ ...prev, status: e.target.value })), className: "glass-input text-sm" }, /* @__PURE__ */ React.createElement("option", { value: "all" }, "Tat ca"), /* @__PURE__ */ React.createElement("option", { value: "active" }, "Dang hoat dong"), /* @__PURE__ */ React.createElement("option", { value: "scheduled" }, "Chua toi han"), /* @__PURE__ */ React.createElement("option", { value: "inactive" }, "Da tat")), /* @__PURE__ */ React.createElement("input", { type: "date", value: filters.validFrom, onChange: (e) => setFilters((prev) => ({ ...prev, validFrom: e.target.value })), className: "glass-input text-sm w-[130px]" }), /* @__PURE__ */ React.createElement("input", { type: "date", value: filters.validUntil, onChange: (e) => setFilters((prev) => ({ ...prev, validUntil: e.target.value })), className: "glass-input text-sm w-[130px]" }), /* @__PURE__ */ React.createElement("select", { value: filters.sort, onChange: (e) => setFilters((prev) => ({ ...prev, sort: e.target.value })), className: "glass-input text-sm" }, /* @__PURE__ */ React.createElement("option", { value: "newest" }, "Moi nhat"), /* @__PURE__ */ React.createElement("option", { value: "code-asc" }, "A-Z"), /* @__PURE__ */ React.createElement("option", { value: "code-desc" }, "Z-A"), /* @__PURE__ */ React.createElement("option", { value: "highest-discount" }, "% Cao nhat")), /* @__PURE__ */ React.createElement(Button_default, { onClick: openCreate, variant: "primary", className: "whitespace-nowrap" }, /* @__PURE__ */ React.createElement(Plus, { className: "mr-2 h-4 w-4" }), " Tao ma"))), /* @__PURE__ */ React.createElement("div", { className: "admin-table-shell flex-1" }, /* @__PURE__ */ React.createElement("div", { className: "w-full" }, /* @__PURE__ */ React.createElement("table", { className: "w-full text-left" }, /* @__PURE__ */ React.createElement("thead", { className: "bg-white/10 text-slate-500" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "p-4 text-xs font-semibold uppercase tracking-[0.2em]" }, "Ma"), /* @__PURE__ */ React.createElement("th", { className: "p-4 text-xs font-semibold uppercase tracking-[0.2em]" }, "% Giam"), /* @__PURE__ */ React.createElement("th", { className: "p-4 text-xs font-semibold uppercase tracking-[0.2em]" }, "Hieu luc"), /* @__PURE__ */ React.createElement("th", { className: "p-4 text-xs font-semibold uppercase tracking-[0.2em]" }, "Trang thai"), /* @__PURE__ */ React.createElement("th", { className: "p-4 text-xs font-semibold uppercase tracking-[0.2em]" }, "Hanh dong"))), /* @__PURE__ */ React.createElement("tbody", { className: "divide-y divide-white/20" }, loading && /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { colSpan: 5, className: "p-6 text-center text-slate-500" }, "Dang tai...")), !loading && filteredCoupons.length === 0 && /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { colSpan: 5, className: "p-6 text-center text-slate-500" }, "Khong co ma giam gia phu hop")), filteredCoupons.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((coupon) => {
      const now2 = /* @__PURE__ */ new Date();
      const validFrom = coupon.validFrom ? new Date(coupon.validFrom) : null;
      const validUntil = coupon.validUntil ? new Date(coupon.validUntil) : null;
      const isInValidPeriod = (!validFrom || now2 >= validFrom) && (!validUntil || now2 <= validUntil);
      const isActive = coupon.isActive && isInValidPeriod;
      return /* @__PURE__ */ React.createElement("tr", { key: coupon.id, className: "hover:bg-white/20" }, /* @__PURE__ */ React.createElement("td", { className: "p-4 font-semibold text-slate-900" }, coupon.code), /* @__PURE__ */ React.createElement("td", { className: "p-4 text-slate-700" }, coupon.discountPercent, "%"), /* @__PURE__ */ React.createElement("td", { className: "p-4 text-sm text-slate-600" }, /* @__PURE__ */ React.createElement("div", null, coupon.validFrom ? formatDate(coupon.validFrom) : "-"), /* @__PURE__ */ React.createElement("div", null, coupon.validUntil ? formatDate(coupon.validUntil) : "-")), /* @__PURE__ */ React.createElement("td", { className: "p-4" }, /* @__PURE__ */ React.createElement("span", { className: isActive ? "glass-chip text-emerald-700" : "glass-chip text-slate-500" }, isInValidPeriod ? "Hoat dong" : "Ngoai thoi gian")), /* @__PURE__ */ React.createElement("td", { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement("button", { onClick: () => openEdit(coupon), className: "glass-card inline-flex items-center rounded-2xl px-3 py-2 text-sm text-blue-600" }, /* @__PURE__ */ React.createElement(SquarePen, { className: "mr-1 h-4 w-4" }), " Sua"), /* @__PURE__ */ React.createElement("button", { onClick: () => handleDelete(coupon), className: "glass-card inline-flex items-center rounded-2xl px-3 py-2 text-sm text-red-600" }, /* @__PURE__ */ React.createElement(Trash2, { className: "mr-1 h-4 w-4" }), " Xoa"))));
    })))), !loading && Math.ceil(filteredCoupons.length / itemsPerPage) > 1 && /* @__PURE__ */ React.createElement("div", { className: "p-4 border-t border-white/20" }, /* @__PURE__ */ React.createElement(
      Pagination_default,
      {
        currentPage,
    ...
    ))), /* @__PURE__ */ React.createElement(Modal_default, { isOpen: showModal, onClose: () => setShowModal(false), title: editing ? "Sua ma" : "Tao ma moi" }, /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit, className: "p-6" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement(Input_default, { label: "Ma", name: "code", value: form.code, onChange: handleChange, error: formErrors.code, required: true }), /* @__PURE__ */ React.createElement(Input_default, { label: "% Giam", name: "discountPercentage", type: "number", value: form.discountPercentage, onChange: handleChange, error: formErrors.discountPercentage, required: true }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-slate-700" }, "Bat dau"), /* @__PURE__ */ React.createElement("input", { type: "datetime-local", name: "validFrom", value: form.validFrom, onChange: handleChange, className: "glass-input w-full" }), formErrors.validFrom && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.validFrom)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "mb-2 block text-sm font-medium text-slate-700" }, "Ket thuc"), /* @__PURE__ */ React.createElement("input", { type: "datetime-local", name: "validUntil", value: form.validUntil, onChange: handleChange, className: "glass-input w-full" }), formErrors.validUntil && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.validUntil)), /* @__PURE__ */ React.createElement(Input_default, { label: "Luot su dung (limit)", name: "usageLimit", type: "number", value: form.usageLimit, onChange: handleChange }), /* @__PURE__ */ React.createElement("label", { className: "glass-card flex items-center gap-3 rounded-2xl px-4 py-3 text-sm text-slate-700" }, /* @__PURE__ */ React.createElement(Tag, { className: "h-4 w-4 text-coffee-700" }), /* @__PURE__ */ React.createElement("input", { type: "checkbox", name: "isActive", checked: form.isActive, onChange: handleChange }), /* @__PURE__ */ React.createElement("span", null, "Kich hoat"))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex justify-end gap-2" }, /* @__PURE__ */ React.createElement(Button_default, { type: "button", variant: "ghost", onClick: () => setShowModal(false) }, "Huy"), /* @__PURE__ */ React.createElement(Button_default, { type: "submit", isLoading: submitting }, editing ? "Luu" : "Tao")))));
  }
})();
