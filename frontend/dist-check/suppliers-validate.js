(() => {
  ...
  var MapPin = createLucideIcon("map-pin", __iconNode4);
  ...
  var Phone = createLucideIcon("phone", __iconNode5);
  ...
  var normalizeSupplierListResponse = (response) => {
    const data = response?.data ?? response;
    const suppliers = Array.isArray(data) ? data : data?.suppliers?.data || data?.suppliers || data?.data || response?.suppliers || [];
    return {
      ...response,
      data: suppliers
    };
  };
  var normalizeSupplierDetailResponse = (response) => {
    const data = response?.data ?? response;
  ...
  var supplierAPI = {
    ...
    getAllSuppliers: async () => {
      const response = await axiosConfig_default.get("/suppliers/");
      return normalizeSupplierListResponse(response);
    },
    // Lấy nhà cung cấp theo ID
    getSupplierById: async (supplierId) => {
      const response = await axiosConfig_default.get(`/suppliers/${supplierId}`);
      return normalizeSupplierDetailResponse(response);
    },
    // Admin: Thêm nhà cung cấp mới
    createSupplier: async (supplierData) => {
      return await axiosConfig_default.post("/suppliers/add", supplierData);
    },
    ...
    deleteSupplier: async (supplierId) => {
      return await axiosConfig_default.delete(`/suppliers/delete/${supplierId}`);
    }
  };
  var supplierAPI_default = supplierAPI;
  ...
  var SUPPLIER_CODE_REGEX = /^[A-Z0-9-]+$/;
  var validateSupplierForm = (formData) => {
    const errors = {};
  ...
  var AdminSuppliersPage = () => {
    ...
    const fetchSuppliers = async () => {
      setIsLoading(true);
      try {
        const response = await supplierAPI_default.getAllSuppliers();
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (editingSupplier) {
          await supplierAPI_default.updateSupplier(editingSupplier.id, submitData);
          toast.success("Cap nhat nha cung cap thanh cong");
        } else {
          await supplierAPI_default.createSupplier(submitData);
    ...
    const handleDelete = async (supplierId) => {
      ...
      try {
        const resolvedId = supplierId?.id || supplierId?.supplierId || supplierId?.supplier_id || supplierId;
        await supplierAPI_default.deleteSupplier(resolvedId);
    ...
    const filteredSuppliers = suppliers.filter((supplier) => {
      ...
      const searchMatch = !searchLower || supplier.name?.toLowerCase().includes(searchLower) || supplier.code?.toLowerCase().includes(searchLower) || supplier.address?.toLowerCase().includes(searchLower) || supplier.contactInfo?.toLowerCase().includes(searchLower);
      const status = supplier.isActive === 0 || supplier.isActive === false ? "inactive" : "active";
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-gray-900" }, "Quan Ly Nha Cung Cap"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mt-1" }, "Quan ly thong tin cac nha cung cap san pham")), /* @__PURE__ */ React.createElement(Button_default, { onClick: () => handleOpenModal(), variant: "primary" }, /* @__PURE__ */ React.createElement(Plus, { className: "w-5 h-5 mr-2" }), "Them Nha Cung Cap")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6 border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-blue-100 rounded-lg" }, /* @__PURE__ */ React.createElement(Building2, { className: "w-6 h-6 text-blue-600" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Tong Nha Cung Cap"), /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, suppliers.length)))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6 border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-green-100 rounded-lg" }, /* @__PURE__ */ React.createElement(Users, { className: "w-6 h-6 text-green-600" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Dang Hoat Dong"), /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, suppliers.filter((s) => s.isActive !== 0 && s.isActive !== false).length)))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6 border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-red-100 rounded-lg" }, /* @__PURE__ */ React.createElement(Users, { className: "w-6 h-6 text-red-600" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Ngung Hoat Dong"), /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, suppliers.filter((s) => s.isActive === 0 || s.isActive === false).length))))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-lg shadow-sm p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-[220px]" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
    ...
    ), (searchTerm || filters.status !== "all") && /* @__PURE__ */ React.createElement(
      Button_default,
      {
        onClick: () => {
          setSearchTerm("");
      ...
      "Xoa Loc"
    )), showAdvanced && /* @__PURE__ */ React.createElement("div", { className: "mt-4 grid grid-cols-1 gap-3 md:grid-cols-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Trang thai"), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "all" }, "Tat ca"),
      /* @__PURE__ */ React.createElement("option", { value: "active" }, "Dang hoat dong"),
      /* @__PURE__ */ React.createElement("option", { value: "inactive" }, "Ngung hoat dong")
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Sap xep"), /* @__PURE__ */ React.createElement(
      "select",
      {
        value: filters.sort,
      ...
      /* @__PURE__ */ React.createElement("option", { value: "code-asc" }, "Ma tang dan"),
      /* @__PURE__ */ React.createElement("option", { value: "code-desc" }, "Ma giam dan")
    )))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-lg shadow-sm overflow-hidden" }, isLoading ? /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center h-64" }, /* @__PURE__ */ React.createElement("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-coffee-600" })) : /* @__PURE__ */ React.createElement("table", { className: "w-full" }, /* @__PURE__ */ React.createElement("thead", { className: "bg-gray-50" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "Ten Cong Ty"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "Thong Tin Lien Lac"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "Dia Chi"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase" }, "Thao Tac"))), /* @__PURE__ */ React.createElement("tbody", { className: "divide-y divide-gray-200" }, filteredSuppliers.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).length > 0 ? filteredSuppliers.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((supplier) => /* @__PURE__ */ React.createElement("tr", { key: supplier.id, className: "hover:bg-gray-50" }, /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 bg-coffee-100 rounded-lg flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Building2, { className: "w-5 h-5 text-coffee-600" })), /* @__PURE__ */ React.createElement("p", { className: "font-bold text-gray-900" }, supplier.name))), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, supplier.contactInfo && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-sm text-gray-600" }, /* @__PURE__ */ React.createElement(Phone, { className: "w-4 h-4" }), supplier.contactInfo))), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-2 text-sm text-gray-600" }, /* @__PURE__ */ React.createElement(MapPin, { className: "w-4 h-4 mt-0.5 flex-shrink-0" }), /* @__PURE__ */ React.createElement("span", { className: "line-clamp-2" }, supplier.address || "-"))), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4 text-right" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-end gap-2" }, /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    ))))) : /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { colSpan: "5", className: "px-6 py-12 text-center text-gray-500" }, "Khong tim thay nha cung cap nao")))), !isLoading && Math.ceil(filteredSuppliers.length / itemsPerPage) > 1 && /* @__PURE__ */ React.createElement("div", { className: "p-4 border-t border-gray-200" }, /* @__PURE__ */ React.createElement(
      Pagination_default,
      {
        currentPage,
      ...
      /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between p-6 border-b" }, /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-bold text-gray-900" }, editingSupplier ? "Sua Nha Cung Cap" : "Them Nha Cung Cap Moi"), /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
          onClick: handleCloseModal,
      ...
      )), /* @__PURE__ */ React.createElement("div", { className: "p-6 space-y-4 max-h-[70vh] overflow-y-auto" }, /* @__PURE__ */ React.createElement(
        Input_default,
        {
          label: "Ten cong ty *",
          name: "name",
          ...
          required: true,
          icon: /* @__PURE__ */ React.createElement(Building2, { className: "w-5 h-5" }),
        ...
        Input_default,
        {
          ...
          icon: /* @__PURE__ */ React.createElement(User, { className: "w-5 h-5" }),
      ...
      )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Dia chi"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(MapPin, { className: "absolute left-3 top-3 w-5 h-5 text-gray-400" }), /* @__PURE__ */ React.createElement(
        "textarea",
        {
      ...
      )), formErrors.address && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.address))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-end gap-3 p-6 border-t bg-gray-50" }, /* @__PURE__ */ React.createElement(
        Button_default,
        {
          type: "button",
          onClick: handleCloseModal,
        ...
        "Huy"
      ), /* @__PURE__ */ React.createElement(Button_default, { type: "submit", variant: "primary" }, editingSupplier ? "Cap Nhat" : "Them Moi")))
    )))));
  };
  var AdminSuppliersPage_default = AdminSuppliersPage;
})();
