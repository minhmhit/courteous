...
// src/pages/admin/AdminHRMPage.jsx
...
var Phone = createLucideIcon("phone", __iconNode7);
...
var SquarePen = createLucideIcon("square-pen", __iconNode11);
...
var API_BASE_URL = import.meta.env.VITE_API_BASE_URL || "http://localhost:3000/api/v1";
...
var API_BASE_URL2 = import.meta.env.VITE_API_BASE_URL || "http://localhost:3000/api/v1";
var redirectToLogin = () => {
  clearSession();
  setTimeout(() => {
...
var employeeAPI = {
  ...
  getAllEmployees: async (params = {}) => {
    return await axiosConfig_default.get("/employees", { params });
  },
  // Admin: chi ti?t nh?n vi?n
  getEmployeeById: async (employeeId) => {
    return await axiosConfig_default.get(`/employees/${employeeId}`);
  },
  // Self: profile
  getMyProfile: async () => {
    return await axiosConfig_default.get("/employees/me");
  },
  updateMyProfile: async (payload) => {
    return await axiosConfig_default.patch("/employees/me", payload);
  },
  // Admin/HR: t?o nh?n vi?n
  createEmployee: async (payload) => {
    try {
      return await axiosConfig_default.post("/employees", payload);
    } catch (error) {
      if (error?.response?.status === 404) {
        return await axiosConfig_default.post("/admin/users", payload);
      }
      throw error;
    }
  },
  ...
  updateEmployee: async (employeeId, payload) => {
    try {
      return await axiosConfig_default.patch(`/employees/${employeeId}`, payload);
    } catch (error) {
      if (error?.response?.status === 404) {
        return await axiosConfig_default.patch(`/admin/users/${employeeId}`, payload);
      }
      throw error;
    }
  },
  updateEmployeeStatus: async (employeeId, payload) => {
    return await axiosConfig_default.patch(`/employees/${employeeId}/status`, payload);
  },
  // Position history
  getPositionHistory: async (employeeId) => {
    return await axiosConfig_default.get(`/employees/${employeeId}/position-history`);
  },
...
var employeeAPI_default = employeeAPI;

// src/services/departmentAPI.js
var departmentAPI = {
  getAllDepartments: async () => {
    return await axiosConfig_default.get("/departments");
  },
  getDepartmentById: async (id3) => {
    return await axiosConfig_default.get(`/departments/${id3}`);
  },
  createDepartment: async (payload) => {
    return await axiosConfig_default.post("/departments", payload);
  },
  updateDepartment: async (id3, payload) => {
    return await axiosConfig_default.patch(`/departments/${id3}`, payload);
  },
  toggleDepartment: async (id3, payload) => {
    return await axiosConfig_default.patch(`/departments/${id3}/active`, payload);
  }
};
var departmentAPI_default = departmentAPI;

// src/services/positionAPI.js
var positionAPI = {
  getAllPositions: async () => {
    return await axiosConfig_default.get("/positions");
  },
  getPositionById: async (id3) => {
    return await axiosConfig_default.get(`/positions/${id3}`);
  },
  createPosition: async (payload) => {
    return await axiosConfig_default.post("/positions", payload);
  },
  updatePosition: async (id3, payload) => {
    return await axiosConfig_default.patch(`/positions/${id3}`, payload);
  },
  togglePosition: async (id3, payload) => {
    return await axiosConfig_default.patch(`/positions/${id3}/active`, payload);
  }
};
var positionAPI_default = positionAPI;
...
// src/pages/admin/AdminHRMPage.jsx
var EMPLOYEE_CODE_REGEX = /^EMP(00[1-9]|0[1-9]\d|[1-9]\d{2})$/;
var getApiErrorMessage = (error, fallbackMessage) => {
...
var AdminHRMPage = () => {
  ...
  const [employees, setEmployees] = (0, import_react27.useState)([]);
  const [departments, setDepartments] = (0, import_react27.useState)([]);
  const [positions, setPositions] = (0, import_react27.useState)([]);
  ...
  const [editingEmployee, setEditingEmployee] = (0, import_react27.useState)(null);
  const [initialPositionState, setInitialPositionState] = (0, import_react27.useState)(null);
  const [employeeCodeError, setEmployeeCodeError] = (0, import_react27.useState)("");
  ...
  const [formData, setFormData] = (0, import_react27.useState)({
    ...
    positionId: "",
    baseSalary: "",
    roleEffectiveDate: (/* @__PURE__ */ new Date()).toISOString().split("T")[0]
  });
  ...
  const fetchEmployees = async () => {
    setIsLoading(true);
    try {
      const response = await employeeAPI_default.getAllEmployees({
        page: 1,
        limit: 200
      });
      ...
      toast.error("Kh\xF4ng th\u1EC3 t\u1EA3i danh s\xE1ch nh\xE2n vi\xEAn");
    } finally {
      setIsLoading(false);
    }
  };
  const fetchDepartments = async () => {
    try {
      const response = await departmentAPI_default.getAllDepartments();
  ...
  const fetchPositions = async () => {
    try {
      const response = await positionAPI_default.getAllPositions();
  ...
  const handleOpenModal = async (employee = null) => {
    if (employee) {
      ...
      setFormData({
        ...
        roleId: employee.roleId || employee.role_id || employee.user?.roleId || employee.user?.role_id || "",
      ...
      try {
        const historyRes = await employeeAPI_default.getPositionHistory(employee.id);
        const historyList = historyRes?.data || historyRes?.items || historyRes?.history || [];
        if (Array.isArray(historyList) && historyList.length > 0) {
          ...
          setFormData((prev) => ({
            ...prev,
            positionId: latest.positionId || latest.position_id || latest.position?.id || prev.positionId,
            baseSalary: latest.baseSalary || latest.base_salary || latest.salary || prev.baseSalary,
            roleEffectiveDate: latest.effectiveFrom || latest.effective_from || latest.effectiveDate || prev.roleEffectiveDate
          }));
          setInitialPositionState({
            ...
            effectiveFrom: String(
              latest.effectiveFrom || latest.effective_from || latest.effectiveDate || ""
            )
          });
        }
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!editingEmployee && !formData.password) {
      toast.error("Vui l\xF2ng nh\u1EADp m\u1EADt kh\u1EA9u cho nh\xE2n vi\xEAn m\u1EDBi");
      return;
    }
    ...
    try {
      const payload = {
        ...
        roleId: formData.roleId ? Number(formData.roleId) : void 0,
        address: formData.address,
        departmentId: formData.departmentId ? Number(formData.departmentId) : void 0,
        positionId: formData.positionId ? Number(formData.positionId) : void 0,
        baseSalary: formData.baseSalary ? Number(formData.baseSalary) : void 0
      };
      ...
      if (editingEmployee) {
        await employeeAPI_default.updateEmployee(editingEmployee.id, submitData);
        const hasPositionChange = String(formData.positionId || "") !== String(initialPositionState?.positionId || "") || String(formData.baseSalary || "") !== String(initialPositionState?.baseSalary || "") || String(formData.roleEffectiveDate || "") !== String(initialPositionState?.effectiveFrom || "");
        if (hasPositionChange && formData.roleEffectiveDate && formData.positionId && formData.baseSalary) {
          await employeeAPI_default.addPositionHistory(editingEmployee.id, {
            positionId: Number(formData.positionId),
            baseSalary: Number(formData.baseSalary || 0),
            effectiveFrom: formData.roleEffectiveDate
          });
        }
        toast.success("C\u1EADp nh\u1EADt nh\xE2n vi\xEAn th\xE0nh c\xF4ng");
      } else {
        const res = await employeeAPI_default.createEmployee(submitData);
        const payloadRes = res?.data?.data || res?.data || res;
        const newEmployeeId = payloadRes?.id || payloadRes?.employeeId || payloadRes?.employee?.id || payloadRes?.userId || null;
        if (newEmployeeId && formData.roleEffectiveDate && formData.positionId && formData.baseSalary) {
          await employeeAPI_default.addPositionHistory(newEmployeeId, {
            positionId: Number(formData.positionId),
            baseSalary: Number(formData.baseSalary || 0),
            effectiveFrom: formData.roleEffectiveDate
          });
        }
        toast.success("Th\xEAm nh\xE2n vi\xEAn th\xE0nh c\xF4ng");
      }
      handleCloseModal();
      fetchEmployees();
    } catch (error) {
      console.error("Error saving employee:", error);
      toast.error(getApiErrorMessage(error, "Kh\xF4ng th\u1EC3 l\u01B0u nh\xE2n vi\xEAn"));
    }
  };
  const handleDelete = async (employeeId) => {
    if (!confirm("B\u1EA1n c\xF3 ch\u1EAFc mu\u1ED1n x\xF3a nh\xE2n vi\xEAn n\xE0y?")) return;
    try {
      await employeeAPI_default.updateEmployeeStatus(employeeId, {
        status: "TERMINATED"
      });
      toast.success("\u0110\xE3 x\xF3a nh\xE2n vi\xEAn");
      fetchEmployees();
    } catch (error) {
      console.error("Error deleting employee:", error);
      toast.error(getApiErrorMessage(error, "Kh\xF4ng th\u1EC3 c\u1EADp nh\u1EADt nh\xE2n vi\xEAn"));
    }
  };
  const getRoleKey = (employee) => {
    const dept = (employee.departmentCode || employee.departmentName || "").toUpperCase();
    if (dept.includes("BOD") || dept.includes("ADMIN") || dept.includes("GI\xC1M \u0110\u1ED0C")) return 1;
    if (dept.includes("WAREHOUSE") || dept.includes("KHO") || dept.includes("WH")) return 3;
    if (dept.includes("SALE") || dept.includes("B\xC1N H\xC0NG")) return 4;
    if (dept.includes("HR") || dept.includes("NH\xC2N S\u1EF0")) return 5;
    return 0;
  };
  const getRoleName = (employee) => {
    const positionName = employee.currentPosition?.name || employee.currentPositionName || employee.positionName || employee.position_name;
    if (positionName) return positionName;
    const roleIdNum = Number(getRoleKey(employee));
    if (roleIdNum === 1) return "Admin";
    if (roleIdNum === 3) return "Nh\xE2n Vi\xEAn Kho";
    if (roleIdNum === 4) return "Nh\xE2n Vi\xEAn B\xE1n H\xE0ng";
    if (roleIdNum === 5) return "Qu\u1EA3n L\xFD (HR)";
    return "Nh\xE2n Vi\xEAn";
  };
  ...
  const getStatusLabel = (employee) => {
    const status = employee.status || (employee.isActive === 0 ? "INACTIVE" : "ACTIVE");
    const normalized = String(status).toUpperCase();
    if (normalized === "TERMINATED") {
      return { label: "\u0110\xE3 x\xF3a", className: "bg-red-100 text-red-800" };
    }
    if (normalized === "RESIGNED") {
      return { label: "\u0110\xE3 ngh\u1EC9 vi\u1EC7c", className: "bg-slate-100 text-slate-700" };
    }
    if (normalized === "INACTIVE") {
      return { label: "\u0110\xE3 kh\xF3a", className: "bg-red-100 text-red-800" };
    }
  ...
  const filteredEmployees = employees.filter((employee) => {
    const searchMatch = employee.username?.toLowerCase().includes(searchTerm.toLowerCase()) || employee.email?.toLowerCase().includes(searchTerm.toLowerCase()) || employee.user_email?.toLowerCase().includes(searchTerm.toLowerCase()) || employee.fullName?.toLowerCase().includes(searchTerm.toLowerCase()) || employee.full_name?.toLowerCase().includes(searchTerm.toLowerCase()) || employee.name?.toLowerCase().includes(searchTerm.toLowerCase()) || employee.user_name?.toLowerCase().includes(searchTerm.toLowerCase());
    const roleKey = getRoleKey(employee);
    const roleMatch = roleFilter === "all" || Number(roleKey) === Number(roleFilter);
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-gray-900" }, "Qu\u1EA3n L\xFD Nh\xE2n S\u1EF1 (HRM)"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mt-1" }, "Qu\u1EA3n l\xFD nh\xE2n vi\xEAn v\xE0 ph\xE2n quy\u1EC1n")), /* @__PURE__ */ React.createElement(Button_default, { onClick: () => handleOpenModal(), variant: "primary" }, /* @__PURE__ */ React.createElement(Plus, { className: "w-5 h-5 mr-2" }), "Th\xEAm Nh\xE2n Vi\xEAn")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6 border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-blue-100 rounded-lg" }, /* @__PURE__ */ React.createElement(Users, { className: "w-6 h-6 text-blue-600" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "T\u1ED5ng Nh\xE2n Vi\xEAn"), /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, employees.length)))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6 border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-purple-100 rounded-lg" }, /* @__PURE__ */ React.createElement(Shield, { className: "w-6 h-6 text-purple-600" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Admin"), /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, employees.filter(
    (e) => Number(getRoleKey(e)) === 1
  ).length)))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6 border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-green-100 rounded-lg" }, /* @__PURE__ */ React.createElement(Award, { className: "w-6 h-6 text-green-600" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Nh\xE2n Vi\xEAn Ho\u1EA1t \u0110\u1ED9ng"), /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, employees.filter((e) => {
    const status = e.status || e.employee_status || e.user_status || (e.isActive === 0 ? "INACTIVE" : "ACTIVE");
    return ["ACTIVE", "PROBATION", "ON_LEAVE"].includes(
      String(status).toUpperCase()
    );
  }).length)))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6 border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-orange-100 rounded-lg" }, /* @__PURE__ */ React.createElement(Calendar, { className: "w-6 h-6 text-orange-600" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "Th\xE1ng N\xE0y"), /* @__PURE__ */ React.createElement("p", { className: "text-2xl font-bold text-gray-900" }, (/* @__PURE__ */ new Date()).toLocaleDateString("vi-VN", { month: "long" })))))), /* @__PURE__ */ React.createElement("div", { className: "glass-card rounded-2xl p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-4" }, /* @__PURE__ */ React.createElement(Clock, { className: "w-5 h-5 text-gray-500" }), roleOptions.map((option) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: option.value,
      onClick: () => {
      ...
      className: `px-4 py-2 rounded-lg font-medium transition-colors ${roleFilter === option.value ? "bg-coffee-600 text-white shadow-[0_12px_30px_rgba(85,50,27,0.25)]" : "bg-white/55 text-gray-700 hover:bg-white/70 border border-white/40"}`
    },
    option.label,
    " (",
    option.count,
    ...
    Input_default,
    {
      ...
      icon: /* @__PURE__ */ React.createElement(Search, { className: "w-5 h-5" })
    }
  )), /* @__PURE__ */ React.createElement("div", { className: "admin-table-shell" }, isLoading ? /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center h-64" }, /* @__PURE__ */ React.createElement("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-coffee-600" })) : /* @__PURE__ */ React.createElement("table", { className: "w-full" }, /* @__PURE__ */ React.createElement("thead", { className: "bg-white/60" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "Nh\xE2n Vi\xEAn"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "Li\xEAn H\u1EC7"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "Ch\u1EE9c V\u1EE5"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "L\u01B0\u01A1ng C\u01A1 B\u1EA3n"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" }, "Tr\u1EA1ng Th\xE1i"), /* @__PURE__ */ React.createElement("th", { className: "px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase" }, "Thao T\xE1c"))), /* @__PURE__ */ React.createElement("tbody", { className: "divide-y divide-white/60" }, filteredEmployees.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).length > 0 ? filteredEmployees.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((employee) => {
    const displayName = employee.userName;
    const displayEmail = employee.userEmail;
    const displayPhone = employee.phoneNumber;
    const displayname = employee.username;
    const roleKey = getRoleKey(employee);
    const rawStatus = String(
      employee.status || employee.employee_status || employee.user_status || (employee.isActive === 0 ? "INACTIVE" : "ACTIVE")
    ).toUpperCase();
    const statusInfo = rawStatus === "TERMINATED" ? { label: "\u0110\xE3 x\xF3a", className: "bg-red-100 text-red-800" } : rawStatus === "RESIGNED" ? {
      label: "\u0110\xE3 ngh\u1EC9 vi\u1EC7c",
      className: "bg-slate-100 text-slate-700"
    } : getStatusLabel(employee);
    return /* @__PURE__ */ React.createElement("tr", { key: employee.id, className: "hover:bg-white/40" }, /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-gray-900" }, displayName), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600" }, "@", displayname))), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-sm text-gray-600" }, /* @__PURE__ */ React.createElement(Mail, { className: "w-4 h-4" }), displayEmail), displayPhone && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-sm text-gray-600" }, /* @__PURE__ */ React.createElement(Phone, { className: "w-4 h-4" }), displayPhone))), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement(
      "span",
      {
    ...
    )), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-semibold text-gray-900" }, getBaseSalary(employee) > 0 ? formatCurrency(getBaseSalary(employee)) : "--")), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4" }, /* @__PURE__ */ React.createElement(
      "span",
      {
        className: `inline-flex items-center px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap ${statusInfo.className}`
      },
      statusInfo.label
    )), /* @__PURE__ */ React.createElement("td", { className: "px-6 py-4 text-right" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-end gap-2" }, /* @__PURE__ */ React.createElement(
      "button",
      {
    ...
    "Kh\xF4ng t\xECm th\u1EA5y nh\xE2n vi\xEAn n\xE0o"
  )))), !isLoading && Math.ceil(filteredEmployees.length / itemsPerPage) > 1 && /* @__PURE__ */ React.createElement(
    Pagination_default,
    {
  ...
  )), /* @__PURE__ */ React.createElement(AnimatePresence, null, showModal && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-50 overflow-y-auto" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-center min-h-screen px-4 pt-4 pb-20" }, /* @__PURE__ */ React.createElement(
    motion.div,
    {
      initial: { opacity: 0 },
      animate: { opacity: 1 },
    ...
    /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between p-6 border-b" }, /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-bold text-gray-900" }, editingEmployee ? "S\u1EEDa Nh\xE2n Vi\xEAn" : "Th\xEAm Nh\xE2n Vi\xEAn M\u1EDBi"), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        onClick: handleCloseModal,
    ...
    )), /* @__PURE__ */ React.createElement("div", { className: "p-6 space-y-4 max-h-[70vh] overflow-y-auto" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
        label: "Email *",
        name: "email",
        ...
        required: true,
        disabled: isEditing,
        icon: /* @__PURE__ */ React.createElement(Mail, { className: "w-5 h-5" })
      }
    ), /* @__PURE__ */ React.createElement(
      Input_default,
      {
        label: editingEmployee ? "M\u1EADt kh\u1EA9u (\u0111\u1EC3 tr\u1ED1ng n\u1EBFu kh\xF4ng \u0111\u1ED5i)" : "M\u1EADt kh\u1EA9u *",
        name: "password",
        type: "password",
      ...
      Input_default,
      {
        ...
        onChange: (e) => {
          ...
          setEmployeeCodeError(
            EMPLOYEE_CODE_REGEX.test(nextValue.trim()) ? "" : "M\xE3 nh\xE2n vi\xEAn ph\u1EA3i theo \u0111\u1ECBnh d\u1EA1ng EMP001 \u0111\u1EBFn EMP999"
          );
        },
      ...
      Input_default,
      {
        ...
        disabled: isEditing,
        icon: /* @__PURE__ */ React.createElement(Phone, { className: "w-5 h-5" })
      }
    )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
    ...
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Ch\u1EE9c V\u1EE5 *"), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Ch\u1ECDn quy\u1EC1n --"),
      /* @__PURE__ */ React.createElement("option", { value: 2 }, "Nh\xE2n vi\xEAn"),
      /* @__PURE__ */ React.createElement("option", { value: 1 }, "Admin"),
      /* @__PURE__ */ React.createElement("option", { value: 3 }, "Nh\xE2n vi\xEAn kho"),
      /* @__PURE__ */ React.createElement("option", { value: 4 }, "Nh\xE2n vi\xEAn b\xE1n h\xE0ng"),
      /* @__PURE__ */ React.createElement("option", { value: 5 }, "Nh\xE2n s\u1EF1")
    )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Ph\xF2ng ban"), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Ch\u1ECDn ph\xF2ng ban --"),
      departments.map((dept) => /* @__PURE__ */ React.createElement("option", { key: dept.id, value: dept.id }, dept.name || dept.department_name))
    )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Ch\u1EE9c v\u1EE5"), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "-- Ch\u1ECDn ch\u1EE9c v\u1EE5 --"),
      positions.map((pos) => /* @__PURE__ */ React.createElement("option", { key: pos.id, value: pos.id }, pos.name || pos.position_name))
    ))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
        ...
        min: "0",
        step: "1000",
        icon: /* @__PURE__ */ React.createElement(Award, { className: "w-5 h-5" })
      }
    ), /* @__PURE__ */ React.createElement(
      Input_default,
      {
        ...
        onChange: (e) => setFormData({ ...formData, roleEffectiveDate: e.target.value })
      }
    ))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-end gap-3 p-6 border-t bg-gray-50" }, /* @__PURE__ */ React.createElement(
      Button_default,
      {
        type: "button",
        onClick: handleCloseModal,
      ...
      "H\u1EE7y"
    ), /* @__PURE__ */ React.createElement(Button_default, { type: "submit", variant: "primary" }, editingEmployee ? "C\u1EADp Nh\u1EADt" : "Th\xEAm M\u1EDBi")))
  )))));
};
var AdminHRMPage_default = AdminHRMPage;
export {
  AdminHRMPage_default as default
};
