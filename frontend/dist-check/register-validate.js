...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`
  ...
  var isEmail = (value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(String(value || "").trim());
  ...
  var validateRegisterForm = (formData, addressData) => {
    const errors = {};
  ...
  var RegisterPage = () => {
    ...
    const { register, isLoading: authLoading } = useAuthStore_default();
    ...
    const [addressData, setAddressData] = (0, import_react23.useState)({
      receiverName: "",
      phoneNumber: "",
      fullAddress: "",
      addressType: "home"
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gradient-to-br from-coffee-50 to-cream-100 flex items-center justify-center p-4" }, /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-6xl" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-xl p-8" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-8" }, /* @__PURE__ */ React.createElement(Coffee, { className: "w-16 h-16 mx-auto mb-4 text-coffee-600" }), /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-gray-900" }, "Dang Ky"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mt-2" }, "Tao tai khoan moi")), /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit, className: "space-y-4" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
        label: "Ho va ten",
        type: "text",
      ...
      "Dang Ky"
    )), /* @__PURE__ */ React.createElement("p", { className: "text-center mt-6 text-gray-600" }, "Da co tai khoan?", " ", /* @__PURE__ */ React.createElement(
      Link,
      {
        to: "/login",
      ...
      "Dang nhap"
    ))), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-xl p-8" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-8" }, /* @__PURE__ */ React.createElement("div", { className: "w-16 h-16 mx-auto mb-4 bg-coffee-100 rounded-full flex items-center justify-center" }, /* @__PURE__ */ React.createElement(MapPin, { className: "w-8 h-8 text-coffee-600" })), /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-gray-900" }, "Dia Chi"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mt-2" }, "Them dia chi mac dinh")), /* @__PURE__ */ React.createElement("form", { className: "space-y-4" }, /* @__PURE__ */ React.createElement(
      Input_default,
      {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Tinh / Thanh pho ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "Chon tinh"),
      provinces.map((province) => /* @__PURE__ */ React.createElement("option", { key: province.code, value: province.code }, province.name))
    ), formErrors.selectedProvince && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.selectedProvince)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Quan / Huyen ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "Chon quan"),
      districts.map((district) => /* @__PURE__ */ React.createElement("option", { key: district.code, value: district.code }, district.name))
    ), formErrors.selectedDistrict && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.selectedDistrict)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Phuong / Xa ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement(
      "select",
      {
      ...
      /* @__PURE__ */ React.createElement("option", { value: "" }, "Chon phuong"),
      wards.map((ward) => /* @__PURE__ */ React.createElement("option", { key: ward.code, value: ward.code }, ward.name))
    ), formErrors.selectedWard && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.selectedWard))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, "Loai dia chi ", /* @__PURE__ */ React.createElement("span", { className: "text-red-500" }, "*")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3" }, /* @__PURE__ */ React.createElement("label", { className: "flex items-center gap-2 flex-1" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "radio",
        name: "addressType",
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "text-sm text-gray-700" }, "Nha rieng")), /* @__PURE__ */ React.createElement("label", { className: "flex items-center gap-2 flex-1" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "radio",
        name: "addressType",
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "text-sm text-gray-700" }, "Van phong"))), formErrors.addressType && /* @__PURE__ */ React.createElement("p", { className: "mt-1 text-sm text-red-600" }, formErrors.addressType)), /* @__PURE__ */ React.createElement("div", { className: "bg-blue-50 border border-blue-200 rounded-lg p-3 text-xs text-blue-700" }, "Dia chi nay se duoc dat lam dia chi mac dinh cho cac don hang tiep theo."))))));
  };
